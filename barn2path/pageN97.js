...
async function makeData() {
    ...
    dataForm = dataForm.replace("A", "$");
    dataForm = dataForm.replace("M", "!");
    dataForm = dataForm.replace("C", "@");
    dataForm = dataForm.replace("D", "#");
    dataForm = dataForm.replace("w", "&");
    dataForm = dataForm.replace("j", "*");
    dataForm = dataForm.replace("I", "^");
    dataForm = dataForm.replace("i", "%");
    dataForm = dataForm.replace("g", "<");
    dataForm = dataForm.replace("g", ">");
    dataForm = dataForm.replace("S", "?");
    return dataForm;
}
