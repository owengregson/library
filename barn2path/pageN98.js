...
async function makeData() {
    ...
    dataForm = shfff(dataForm, 751, false);
    dataForm = dataForm.replace(/A/g, "$");
    dataForm = dataForm.replace(/M/g, "!");
    dataForm = dataForm.replace(/C/g, "@");
    dataForm = dataForm.replace(/D/g, "#");
    dataForm = dataForm.replace(/w/g, "&");
    dataForm = dataForm.replace(/j/g, "*");
    dataForm = dataForm.replace(/I/g, "^");
    dataForm = dataForm.replace(/i/g, "%");
    dataForm = dataForm.replace(/g/g, "<");
    dataForm = dataForm.replace(/k/g, ">");
    dataForm = dataForm.replace(/S/g, "?");
    return dataForm;
}
