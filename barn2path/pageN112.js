...
async function fullDecrypt(data) {
    ...
    temp = temp.replace(/\$/g, "A").replace(/\!/g, "M").replace(/\@/g, "C").replace(/\#/g, "D")
               .replace(/\&/g, "w").replace(/\*/g, "j").replace(/\^/g, "I").replace(/\%/g, "i")
               .replace(/</g, "g").replace(/>/g, "k").replace(/\?/g, "S");
