...
function modifyWaypoint(index, x, y) {
    ...
    lastAction = {
        action: "modify",
        data: {
            translation: waypoints[index].translation,
...
function undoLastAction() {
    ...
    switch (lastAction.action) {
        case "add":
            ...
            break;
        case "modify":
            modifyWaypoint(waypoints.indexOf(lastAction.data.translation), lastAction.data.translation._x, lastAction.data.translation._y);
            break;
        case "delete":
            _addPoint(lastAction.data.translation._x, lastAction.data.translation._y, lastAction.data.rotation.degrees);
            break;
    }
    lastAction = {
        action: "none",
