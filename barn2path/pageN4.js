...
function drawRobot(position, heading) {
    ...
    angles.forEach(function(angle) {
        ...
        points.push(point);
        let color = Math.abs(angle - heading) < pi / 2 ? Colors.LIGHT_BLUE : getNextColor();
        // NEW COLOR (KNOWS WHETHER WE ARE DRAWING BOTTOM, TOP, LEFT, OR RIGHT)
